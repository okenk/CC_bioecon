...
sim_pars <- list(spp.names = spp.names, fleets = fleets, wks_per_yr = wks_per_yr, nyrs = nyrs, npops = npops,
                 ...
                 avg_wt = avg_wt, weight_cv = weight_cv, recruit_cv = recruit_cv, fixed_costs = fixed_costs, 
                 cost_per_trip = cost_per_trip, cost_cv = cost_cv, cost_corr = cost_corr, 
                 salmon_tac_rule = salmon_tac_rule)
...
xx <- uniroot(calc_var_cost, interval = c(-20,0),
              cost_cv = cost_cv, recruits = 1, wt_at_rec = 1, price = c(2,10), #price['crab'], c(alpha_price, beta_price),
...
xx <- uniroot(calc_var_cost, interval = c(-20, 0),
              cost_cv = cost_cv, recruits = 1, wt_at_rec = 1, price = price['salmon'],
